...
广东省教育部门于 1960 年 9 月公布的“**潮州话拼音方案**”，简称“**潮拼（Dio5-Pêng1/Diê5-Pêng1，DP）**”，依然是目前比较主流的潮州话拼音方案。
该拼音方案书写上比较贴近普通话拼音方案的拼写习惯。
...
1. 其他地区口音可对应地调整潮拼的拼写。
   例如，“嫣”韵的白话字 ian 在潮州可转写为 ieng，在不保留 [n] 韵尾的地区可以转写为 iang；
   相应地，潮拼 iand 在潮州可转写为 iêng，在不保留 [n] 韵尾的地区可以转写为 iang；等等。
   除了白话字的 au/iau 和潮拼的 ao/iao 元音拼写上并不严格对应，其他韵母白话字和潮拼元音的拼写都严格对应，可以从 7 个单元音和各类韵尾组合形成。
...
|----|----|----------------|----|-----|-------|
| 1  | 阴平 |                | 分  | hun | hund1 |
| 2  | 阴上 | \[／\] ◌́ (锐音符) | 粉  | hún | hund2 |
| 3  | 阴去 | \[＼\] ◌̀ (抑音符) | 奋  | hùn | hund3 |
| 4  | 阴入 |                | 忽  | hut | hud4  |
| 5  | 阳平 | \[∧\] ◌̂ (扬抑符) | 云  | hûn | hund5 |
| 6  | 阳上 | \[～\] ◌̃ (波浪符) | 混  | hũn | hund6 |
| 7  | 阳去 | \[－\] ◌̄ (长音符) | 份  | hūn | hund7 |
| 8  | 阳入 | \[／\] ◌́ (锐音符) | 佛  | hút | hud8  |
