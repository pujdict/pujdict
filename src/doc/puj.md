...
市面上常见的潮汕方言/潮州话辞典，记音时要么以潮州音为标准，要么以汕头音为标准。
但其他地区的朋友使用起来依然有障碍：
澄海的朋友会因为“无闭口韵尾”的特点，难以查到某些字词；
同理还有揭阳的朋友“因”“英”不分，潮阳的朋友“余”“污”不分，等等。
一种可行的解法是，选定潮州音或汕头音为标准，为除此之外的语音点注明可能不同的发音。
诚然，字典可以这么做，但如果需要做词典，这或许不是个优雅的解决方案。

为了一劳永逸地解决口音问题，本辞典制定了一套通用的标准音，各地口音则根据不同的映射规则转读。
这套标准音，
包含依然在潮安、丰顺等地得到保留的“前鼻音韵尾” [n]，
包含潮阳、惠来等地“中”“隆”等字的 [i] 介音，
也包含潮安金石、沙溪的特色韵母 [ə]、饶北的特色韵母 [eu]，等等。
除了极个别字在某些地区存在不规则的读音（例如潮阳“莲藕”的“藕”有特殊读音 [nau<TToneLetter v=52 />]，澄海的口语中“相”字发生 [sĩẽ<TToneLetter v=33 />] 到 [sẽ<TToneLetter v=33 />] 的流变等），其他所有汉字都不需要额外记录读音，节省人工录入开销，也方便计算机处理。

辞典的这套标准音，我们不妨参照“老国音”的名字，称其为“**老潮音 (Old Teochew Pronunciation)**”，
或者也可以称其为“**共同潮汕方言 (Proto Teo-Swa)**”，
它的设计基于“潮汕各地次方言源于一个共同祖先，各地语音的演变是成系统的”这一前提假设，即“音变无例外律”。
灵感和理论基础，主要源于徐馥琼老师的博士论文《粤东闽语语音研究》，以及郭必之老师的《Southern Min》一书。
...
1. 在汕头、潮阳、普宁、惠来、陆丰等地（主要是西南部一些地区），近年来出现了声母 [p], [pʰ], [m], [b], [h] 在接元音 u
   ...
   但唇齿音目前还在扩散过程中，仅在 u 元音之前作为声母的自由变体，并没有产生音位对立，因此本辞典拼音中不予区分。

2. 与其他闽南语方言类似，潮州话中的浊塞音 [b], [ɡ] 实际上音值接近于 [ᵐb], [ᵑɡ]，即鼻冠音，是来源于 [m], [ŋ] 的塞化，并非来源于中古全浊塞音。
3. [n], [l] 声母接阳声韵时，有部分地区两个声母混淆；接鼻化韵时，则多统一读 [n]。
   本辞典记录时，这些字的声母主要以中古泥（娘）、来母作为记录依据（简单来说，与普通话中对应声母相同）。
   这两个声母的混淆如果不规则，另记为又音或白读音。
4. 齿头音 [ts], [tsʰ], [s], [j] 在接介音 i 时可以发生腭化读作 [tɕ], [tɕʰ], [ɕ], [dʑ]
   ，同样是自由变体，不产生音位对立。
   在传统白话字拼音方案中，也有 ts/tsh/z 也有 ch/chh/j 分别的记法（如林雄成），用于区分腭化与非腭化。
   为减少记忆负担，本辞典与台罗方案保持一致，只采用 ts/tsh 进行标注（另一方面的考虑是，在潮剧戏腔中，要求字正腔圆，不允许腭化）。
...
1. 上述表中的国际音标是一种“宽式”的记法。
   a 的实际发音可以是 [a]/[ᴀ]/[ɐ]，特别地，在 <TPopupPujNoAccent puj="-iam0"/> <TPopupPujNoAccent puj="-iap0"/> <TPopupPujNoAccent puj="-ian0"/> <TPopupPujNoAccent puj="-iat0"/> 一组韵母中，受到介音和韵尾的双重影响发生高化，从而实际发音更接近于 [ɛ]/[ɜ]，辞典标准音为了音系的系统性仍将主元音记为 <TPopupPujNoAccent puj="a"/>，各地口音中，如有高化则记为 <TPopupPujNoAccent puj="e"/>；
   e 的实际发音可以是 [e]/[ɛ] 等，特别地，榕江腔在接 -ng/-k 韵尾时 e 与 i 相混，可一并读同 [ɪ]/[e]；
...
2. 韵母 <TPopupPujNoAccent puj="ur0"/> 在潮阳等地并入 <TPopupPujNoAccent puj="u0"/>。
...
3. 韵母 <TPopupPujNoAccent puj="or"/> 潮汕大多数地区已丢失，例如：
   ...
   <!-- 金石民间流传有以下一段歌谣（粗体字为 <TPopupPujNoAccent puj="or"/> 韵母）：田**螺**、庵**螺**、布**袋**，打**短短**，担去金石宫**块退**，**退**了买屐**桃**。-->
   ...
   但开口度更大的韵母，那么就应该是一个接近 [ə] 的发音，但彼时也已开始出现与 [o] 的混同。

   另外，泉州话中的科韵与潮州话的 [ə] 并不一一对应。
   潮州话中读 [ə] 的字仅出现于齿龈音声母之后（仅有“块”字特殊，“块”泉漳片声母为齿龈音，在潮汕为舌根音，应属于从泉漳地区分离之后产生的音变）。
   从而，潮州话没有读 [ə] 的（零声母）单字。
4. i 和 u 可以作为齐齿呼和合口呼的介音出现，白话字中声调不标注于介音之上。
...
1. “欧”韵母白话字写作 au，潮拼则遵循借用普通话拼音的原则写作 ao，iau 和 iao 同理。
   其他韵母中的元音，白话字和潮拼的记法是严格对应的，参见单元音表。

2. 韵母 <TPopupPujNoAccent puj="-eu" /> 是饶北（今饶平三饶、潮安凤凰一带）的特色音，在大多数地区转读为 <TPopupPujNoAccent puj="-iu" />，主要出现于鱼韵字中：
...
3. “妖”“腰”等字音具有口音差异，韵母的音变规则在后文展开讨论。
...
3. ng 也可以接在其他辅音声母后，发音同样为 [ŋ̍] 或 [ɯŋ]，例如：
   ...
   潮汕多数地区中，在除了零声母和 [h] 声母之后的 [ŋ̍] 韵，都可以带上一个 [ɯ] 音，韩江腔习惯上 [ɯ] 音较为明显，练江腔则接近于没有元音，
   不过 [ɯ] 音的长短在各地均不构成对立。
   例如在潮州，丢失“前鼻音”后，“根 <TPopupPujNoAccent puj="kurn1"/>”“缸 <TPopupPujNoAccent puj="kng1"/>”两字都可读为 <TPopupPujNoAccent puj="kurng1"/> 或 <TPopupPujNoAccent puj="kng1"/>。
   本辞典中标准音仍将此类韵母记为 <TPopupPujNoAccent puj="-ng"/>，各地口音则为了方便查询，统一转为 <TPopupPujNoAccent puj="-urng"/>。

:::

## 声调

潮汕片闽南语的特征是 8 声调，阴平低、阳平高，阴入低、阳入高。
有些地区单字调由于调值接近，出现混同现象，导致单字调只有 7 个，
例如潮阳棉城 3 声、6 声单字调混同，惠来惠城 3 声、7 声单字调混同，但在连读变调时，还是能够区分混同的声调，所以依然认为具有 8 个声调。
...
1. 主流的声调归类认为 2 声、6 声分别是阴上、阳上，3 声、7 声分别是阴去、阳去。但在较晚近层次的文读音中，全清、次清、次浊上声都归入了
...
4. 第 8 声声调记号采用锐音符 ◌́（同林雄成），也有方案记为竖线符 ◌̍（台罗和卓威廉词典）或扬抑符
   ◌̂（斐尔德字典）。
   台罗采取的是上加竖线，但竖线符号在组合到字母 i 上方时会与点号合并成为 i̍，两者区别可能很不明显，为了增强区分度本辞典默认用锐音符代替。
   （实际上诸位传教士所著字典中，该符号是一个上粗下细的垂直撇号 '，而非竖线，但 Unicode 中没有这样的符号）
...
| 痕很^6^   | <TPopupPujNoAccent puj=-urn0 />                                                                   | <TPopupPujNoAccent puj=-urng0 />                                                                  |
| 欣勋^6^   | <TPopupPujNoAccent puj=-n0 />                                                                     | <TPopupPujNoAccent puj=-ng0 />                                                                    |
...
| 因乙      | <TPopupPujNoAccent puj=-in0 />, <TPopupPujNoAccent puj=-it0 />                                    | (<TPopupPujNoAccent puj=-ing0 />, <TPopupPujNoAccent puj=-ik0 />)                                 |
| 痕很^6^   | <TPopupPujNoAccent puj=-urn0 />                                                                   | (<TPopupPujNoAccent puj=-urng0 />)                                                                |
| 欣勋^6^   | <TPopupPujNoAccent puj=-n0 />                                                                     | (<TPopupPujNoAccent puj=-urng0 />)                                                                |
| 隐乞      | <TPopupPujNoAccent puj=-urn0 />, <TPopupPujNoAccent puj=-urt0 />                                  | (<TPopupPujNoAccent puj=-urng0 />  <TPopupPujNoAccent puj=-urk0 />)                               |
...
| 痕很^6^   | <TPopupPujNoAccent puj=-urn0 />                                                                   | <TPopupPujNoAccent puj=-eng0 />                                          |
| 欣勋^6^   | <TPopupPujNoAccent puj=-n0 />                                                                     | <TPopupPujNoAccent puj=-eng0 />                                          |
...
| 获       | <TPopupPujNoAccent puj=-uek0 />                                                                   |                                                                          |
| 饭问      | (双唇音)<TPopupPujNoAccent puj=-ng0 />                                                               |                                                                          |
| 中筑茸辱^7^ | (齿龈音)<TPopupPujNoAccent puj=-iong0 />, <TPopupPujNoAccent puj=-iok0 />                            | (“而”声母以外)<TPopupPujNoAccent puj=-ong0 />, <TPopupPujNoAccent puj=-ok0 /> |
| 万亡文^8^  | <TPopupPujNoAccent puj=bu- />(阳声韵)                                                                |                                                                          |
| 漫闷      | <TPopupPujNoAccent puj=mu- />(阳声韵)                                                                | <TPopupPujNoAccent puj=bu- />                                            |
| 男念      | n- (m 尾阳声韵)                                                                                       |                                                                          |
| 难能      | n- (n, ng 尾阳声韵)                                                                                   | <TPopupPujNoAccent puj=l- />                                             |
...
| 音邑      | <TPopupPujNoAccent puj=-im0 />, <TPopupPujNoAccent puj=-ip0 />                                    |                                                                   |
| 因乙      | <TPopupPujNoAccent puj=-in0 />, <TPopupPujNoAccent puj=-it0 />                                    | <TPopupPujNoAccent puj=-ing0 />, <TPopupPujNoAccent puj=-ik0 />   |
| 痕很^6^   | <TPopupPujNoAccent puj=-urn0 />                                                                   | <TPopupPujNoAccent puj=-ing0 />                                   |
| 欣勋^6^   | <TPopupPujNoAccent puj=-n0 />                                                                     | <TPopupPujNoAccent puj=-ing0 />                                   |
...
5. 韵母 <TPopupPujNoAccent puj=-eng /> <TPopupPujNoAccent puj=-ek0 /> 来自曾、梗摄文读音，
   ...
   潮汕大部分地区在 -n/-t 韵尾混入 -ng/-k 后，会形成 <TPopupPujNoAccent puj=-ing /> <TPopupPujNoAccent puj=-ik0 /> 和 <TPopupPujNoAccent puj=-eng /> <TPopupPujNoAccent puj=-ek0 /> 的对立。
   因此，本辞典该韵母标准音不采纳泉漳片的 <TPopupPujNoAccent puj=-ing /> <TPopupPujNoAccent puj=-ik0 /> 记法。
   ...
   榕江腔的 <TPopupPujNoAccent puj=-in /> <TPopupPujNoAccent puj=-it0 /> 转为 <TPopupPujNoAccent puj=-eng /> <TPopupPujNoAccent puj=-ek0 /> 音质也接近于 [ɪ] 音。
6. 臻摄一等痕韵，以及三等开口欣韵、合口文韵的韵母白读音，多数地区没有区别，例如汕头同读 <TPopupPujNoAccent puj=urng0 />，揭阳同读 <TPopupPujNoAccent puj=eng0 />。
   但是，在潮州府城，声母 h 之后一等字读 <TPopupPujNoAccent puj=hurng0 />（如“痕”“很”等），三等字读 <TPopupPujNoAccent puj=hng0 />（如“欣”“勋”“殷”等），形成对立；
   这意味着这对韵母可能曾有过开口度大小之别。
   ...
   实际上今天各地均无 [ɯn]/[ən]（或 [ɯŋ]/[əŋ]）这样仅在元音开口度有区分的对立阳声韵。
7. 通摄三等字文读音韵母为 <TPopupPujNoAccent puj=-iong />, <TPopupPujNoAccent puj=-iok0 />，当接在齿龈音后时，
   包括三市市中心在内的东北部多数地区都读为 <TPopupPujNoAccent puj=-ong />, <TPopupPujNoAccent puj=-ok />，
   有且仅有一组例外：<TPopupPujNoAccent puj="thiok"/> 的辖字（“畜”“蓄”“慉”“搐”等）在各地都保留介音 i。
   揭阳则在“而”声母后保留介音 i（即保留 <TPopupPujNoAccent puj="jiong0"/>, <TPopupPujNoAccent puj="jiok0"/>），
   潮阳、普宁、惠来、陆丰等地则在各齿龈音声母后都保留介音 i——这是潮普小片或练江腔的标志性读音。
   不过，近年来受普通话以及强势口音影响，潮阳等地许多年轻人也倾向于丢失 i 介音，i 介音保留与否成为了自由变体，本辞典中相关地区口音仍保留老派的介音。
   ...
   另外，在老派保留闭口韵尾的潮州湘桥、澄海盐鸿等地，近年来出现了一种丢失闭口韵尾的新派音 <TPopupPujNoAccent puj="-iam"/> > <TPopupPujNoAccent puj="-iorm"/> > <TPopupPujNoAccent puj="-iong"/>, <TPopupPujNoAccent puj="-iap0"/> > <TPopupPujNoAccent puj="-iorp0"/> > <TPopupPujNoAccent puj="-iok0"/>，因 [a] 元音在介音和韵尾双重影响下实际音值接近 [ə]，而丢失闭口韵后不稳定的中央元音 [ə] 与现有音系中的 [o] 合流，因此，出现了 <TPopupPujNoAccent puj=-iong />, <TPopupPujNoAccent puj=-iok0 /> 的新音节，例如：
...
9. 潮剧戏腔整体发音接近于未丢失闭口韵的潮安—澄海口音，但偶尔会引入来自其他地区的一些口音进行艺术化处理。
...
1. 主流调型，包括潮汕三市市中心在内大多数地区的调型。这一类型按照前变调的形式也可以进一步细分：
   1. 汕头、饶平音，变调较为“规矩”，通常每个字只有一套前变调，后字声调不会随前字调整，其中第 3 声的前变调为高平调。
   2. 潮州、潮安、揭阳、澄海音，前变调有丰富的变化，第 2、3、4 声根据后字声调的高低，会相应地调整前字的变调，甚至后字的声调也会随之调整，听感上显得更加“连绵”，起伏变化更小；其中第 3 声的前变调为降调。
...
3. 潮阳新派已将 3、6 声两个单字调混同，但在变调中依然可区分。
4. 惠来惠城已将 3、7 声两个单字调混同，但在变调中依然可区分。
