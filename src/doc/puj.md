...
为了更好地兼顾潮汕各地发音，本辞典主要采用白话字（Péh-Uē-Jī, PUJ）拼音方案进行注音。
...
3. o̤ 主要存在于果摄和蟹摄一等字和山摄一等合口入声字白读层，例如：袋 tō̤、块 kò̤、胎 tho̤、罪 tsõ̤、坐 tsõ̤、夺
   tó̤h。该韵母在今天潮汕片闽南语中大多并入 o，但在陆丰、漳州、厦门、台湾强势腔中该韵母并入 e；而在泉州则依然保留 [ə] 的音，并与
   ...
   该韵母并非生造，事实上，高德《汉英潮州方言字典》（1883）的序言中就提到：
...
5. 如果出现鼻化韵 -nn 和喉塞韵 -h 同时出现时，先写 -nn 再写 -h，例如：夗 ínnh（睡觉）。
...
4. 第 8 声声调记号为锐音符 ◌́（同林雄成），也有方案记为竖线符 ◌̍（台罗和卓威廉词典）或扬抑符 ◌̂（斐尔德字典）。实际上，诸位传教士所著字典使用的衬线字体中，该声调的符号是一个从上往下写、上粗下细的一个垂直撇号 '，但 Unicode 中没有收录这样的组合上加符号。台罗采取的是上加竖线，但竖线符号在组合到字母 i 上方时会与点号合并成为 i̍，两者区别可能很不明显，为了增强区分度本辞典中用锐音符代替。
...
一片痴情是苦恋 Tsék-phiàn-tshi-tshêng sĩ-khóu-luàn  
十字路边把你呼喊 Tsáp-jī-lōu-pinn pá-lṳ́ hu-hàm  
当初咱山盟海誓 Tng-tsho nán suann-mêng hái-sī  
为何如今对影只一人 Uî-hô-jû-kim tuì-iánn tsí-tsék-nâng  
...
你可明白这地老天荒 Lṳ́ khó-mêng-péh-tsé-tī-láu thian-huang
...
6. 通摄三等字文读音韵母为 -iong, -iok，当接在齿龈音 t/th/n/l/ts/tsh/s/j 后时，包括三市市中心在内的东部多数地区都读为 -ong,
   ...
   jiông，筑 tiok，六 liók，属 siók，辱 jiók。但有且仅有一组例外：thiok 的辖字（“畜”“蓄”“慉”“搐”）在东部地区依然保留介音 i。
