...
1. 在汕头、潮阳、普宁、惠来、陆丰等地（主要是西南部一些地区），近年来出现了声母 p, ph, m, b, h 在接元音 u
   时，读为唇齿音 [p̪f], [p̪fʰ], [ɱ], [b̪v]/[v], [ɸ]/[f] 的现象，例如：飞 <TPuj puj="pfue1"/>，梅 <TPuj puj="bvue5"/>，
...
1. 上述表中的国际音标是一种“宽式”的记法。
   a 的实际发音可以是 [a]/[ᴀ]/[ɐ]，特别地，在 -iam/-iap/-ian/-iat 一组韵母中，受到介音和韵尾的双重影响发生高化，从而实际发音更接近于 [ɛ]/[ɜ]，辞典标准音为了音系的系统性仍记为 -ian/-iat，各保留该韵母的地区口音则记为 -ien/-iet；
...
3. o̤ 韵母大多数地区已丢失。该韵母属于白读音，对应于泉州话中的科韵，例如：袋 <TPuj puj="tor7"/>、块 <TPuj puj="kor3"/>
   、胎 <TPuj puj="thor1"/>、
...
2. -eu 韵母在大多数地区转读为 -iu，仅在潮安县凤凰镇等极少数地区保留，出现于若干鱼韵字中：
   初 <TPuj puj="tsheu1"/>、
   黍 <TPuj puj="seu3"/>、
   梳 <TPuj puj="seu1"/>、
   疏 <TPuj puj="seu1"/>、
...
3. ng 也可以接在其他辅音声母后，发音同样为 [ŋ̍] 或 [ɯŋ]，例如：
   ...
   实际上，潮汕多数地区该韵母中都有一个比较明显的 [ɯ] 音。本辞典中标准音仍记为 -ng，各地口音则为了方便查询，转为 -ṳng。
...
6. 通摄三等字文读音韵母为 -iong, -iok，当接在齿龈音 t/th/n/l/ts/tsh/s/j 后时，
   包括三市市中心在内的东北部多数地区都读为 -ong, -ok，西南部潮阳、普宁、惠来、陆丰等地则保留介音 i——这是潮普小片或练江腔的标志性读音。
...
8. 潮剧戏腔要求字正腔圆，-ie/-ienn/-ieh、-iou/iouh、-oinn、-in/-it、-ian/-iat、-uan/-uat 为标准发音，但偶尔会引入来自其他地区的
   -io/-ionn/-ioh、-iau/-iauh、-ainn、-eng/-ek、-ieng/-iek、-ueng/-uek 进行艺术化处理。
...
1. 在潮州、澄海、揭阳等地，2、3、4 声三个声调根据前后字声调高低发生相应变化：
    ...
    - 澄海地区在 3 声 + 2 声的组合中，3 声的前变调可以是降调，也可以变为升调，例如：奋起 ꜒꜕ ˨˩ 或 ꜕꜒ ˨˩。两种前变调是自由变体。
