...
export default defineUserConfig({
  ...
  head: [
    ...
    // 提前拉取数据
    ["link", {rel: "prefetch", href: '/data/pujbase/dist/accents.pb.gz', type: 'application/gzip', as: "fetch",}],
    ["link", {rel: "prefetch", href: '/data/pujbase/dist/entries.pb.gz', type: 'application/gzip', as: "fetch",}],
    ["link", {rel: "prefetch", href: '/data/pujbase/dist/phrases.pb.gz', type: 'application/gzip', as: "fetch",}],
