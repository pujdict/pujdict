...
describe('白话字注音', () => {
  ...
  it('句子', () => {
    ...
    expect_puj('Tsap8-ji7-lou7-pinn1 pa2-lur2 hu1-ham3.',
    ...
    expect_puj('Sim1-thau5 tshoinn1-puann1 siang1-sur1-i3,',
    ...
    expect_puj('Lur2 kho2-meng5-peh8-tse2-ti7-lau2 thian1-huang1.',
  ...
  it('特殊韵母（余、倭）', () => {
    expect_puj('ur5', `${PUJSpecialVowels.v}${PUJToneMarks[5]}`);
    expect_puj('tur5', `t${PUJSpecialVowels.v}${PUJToneMarks[5]}`);
    expect_puj('ir5', `${PUJSpecialVowels.v}${PUJToneMarks[5]}`);
    expect_puj('tir5', `t${PUJSpecialVowels.v}${PUJToneMarks[5]}`);

    expect_puj('er5', `${PUJSpecialVowels.r}${PUJToneMarks[5]}`);
    expect_puj('ter5', `t${PUJSpecialVowels.r}${PUJToneMarks[5]}`);
  });
});
